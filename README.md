# Cupcake JavaScript Sample Activities

Canonical sample of how Cupcake activity types are authored in JavaScript (Node.js).

One shared `main.js` plus YAML definitions for each supported activity type (Learning Contents schemas).
